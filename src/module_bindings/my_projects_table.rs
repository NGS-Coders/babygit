...
impl MyProjectsTableAccess for super::RemoteTables {
    fn my_projects(&self) -> MyProjectsTableHandle<'_> {
        MyProjectsTableHandle {
            imp: self.imp.get_table::<Project>("my_projects"),
...
pub(super) fn register_table(client_cache: &mut __sdk::ClientCache<super::RemoteModule>) {
    let _table = client_cache.get_or_make_table::<Project>("my_projects");
}
...
pub trait my_projectsQueryTableAccess {
    ...
    fn my_projects(&self) -> __sdk::__query_builder::Table<Project>;
}
